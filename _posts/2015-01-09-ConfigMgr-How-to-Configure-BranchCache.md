...
This is part 1 of a 2 part post.  This part demonstrates how to install and configure BranchCache while [part two](https://www.fearthepanda.com/sccm-how-to-confirm-branchcache-is-working/) will demonstrate how to determine that BranchCache is actually working.
...
Now we know what we are talking about, here is my approach on how I implemented this using SCCM at my workplace:
...
Today I configured one of our smaller branch offices to use BranchCache with SCCM for application deployment.
